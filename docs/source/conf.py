...
project = 'biomassml'
copyright = f'{date.today().year}, Victoria Gill, Kevin Maik Jablonka'
author = 'Victoria Gill, Kevin Maik Jablonka'
...
modindex_common_prefix = ["biomassml."]
...
htmlhelp_basename = 'biomassmldoc'
