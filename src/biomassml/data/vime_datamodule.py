...
class VIMEDataModule(pl.LightningDataModule):
    def __init__(
        ...
        if scale:
            ...
            self.train_df[self.feature_names] = self.scaler.fit_transform(self.train_df[self.feature_names])
            self.valid_df[self.feature_names] = self.scaler.transform(self.valid_df[self.feature_names])
            self.test_df[self.feature_names] = self.scaler.transform(self.test_df[self.feature_names])
