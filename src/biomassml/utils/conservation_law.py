...
def conservation_loss(y, names, label_scaler=None):
    ...
    if ("volCOMB" in names) and ("volH2" in names) and ("volCO" in names) and ("volCH4" in names):
    ...
    if ("volCO2" in names) and ("volCO" in names) and ("volCH4" in names) and ("volH2" in names):
    ...
    total_conservation_loss = volSYNG_loss + volCOMB_loss + mass_conservation_loss
